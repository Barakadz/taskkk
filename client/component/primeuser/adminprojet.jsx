...
const AdminPrimeValUser = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axios.post('https://task.groupe-hasnaoui.com/api/primeee/mailprime', requestData, {
        headers: {
...
export default AdminPrimeValUser;
